    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form
                    action="{{ route('pegawai.riwayat-pendidikan.update', [$pegawai->id, $riwayatPendidikan->id]) }}"
                    method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="jenjang" id="jenjang"
                                ...
                                <option value="SMA"
                                    {{ old('jenjang', $riwayatPendidikan->jenjang) == 'SMA' ? 'selected' : '' }}>
                                    SMA
                                </option>

                                <option value="D3"
                                    {{ old('jenjang', $riwayatPendidikan->jenjang) == 'D3' ? 'selected' : '' }}>
                                    D3
                                </option>

                                <option value="S1"
                                    {{ old('jenjang', $riwayatPendidikan->jenjang) == 'S1' ? 'selected' : '' }}>
                                    S1
                                </option>

                                <option value="S2"
                                    {{ old('jenjang', $riwayatPendidikan->jenjang) == 'S2' ? 'selected' : '' }}>
                                    S2
                                </option>

                                <option value="S3"
                                    {{ old('jenjang', $riwayatPendidikan->jenjang) == 'S3' ? 'selected' : '' }}>
                                    S3
                                </option>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="program_studi" id="program_studi"
                                ...
                                value="{{ old('program_studi', $riwayatPendidikan->program_studi) }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="perguruan_tinggi" id="perguruan_tinggi"
                                ...
                                value="{{ old('perguruan_tinggi', $riwayatPendidikan->perguruan_tinggi) }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="tahun_lulus" id="tahun_lulus"
                                ...
                                value="{{ old('tahun_lulus', $riwayatPendidikan->tahun_lulus) }}" min="1900"
                                max="{{ date('Y') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="gelar" id="gelar"
                                ...
                                value="{{ old('gelar', $riwayatPendidikan->gelar) }}"
                                placeholder="Contoh: S.Pd., M.Pd., Dr.">
