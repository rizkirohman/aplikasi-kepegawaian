        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('user.update', $user->id) }}" method="POST">
                    ...
                    {{-- Role --}}
                    <div class="form-group mb-3">
                        <label for="role" class="form-label d-block font-weight-bold">
                            Role
                        </label>
                    ...
                    {{-- Pegawai --}}
                    <div class="form-group mb-3">
                        <label for="pegawai_id" class="form-label d-block font-weight-bold">
                            Hubungkan dengan Pegawai
                        </label>

                        <select name="pegawai_id" id="pegawai_id"
                            class="form-control custom-select @error('pegawai_id') is-invalid @enderror">
                        ...
                        <small class="form-text text-muted">
                            Hanya pegawai yang belum memiliki akun atau pegawai yang sedang terhubung dengan user ini yang
                            ditampilkan.
                        </small>
